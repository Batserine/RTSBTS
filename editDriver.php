      ...
      //  session_start();
       // $id = $_SESSION['bus_number'];
        if(isset($_POST['submit']))
          ...
          $query = "SELECT * FROM driver WHERE name  = '$id'";
        $response = @mysqli_query($db, $query);
        if ($response) {

            while ($row = mysqli_fetch_array($response)) {
?>
        <form class="form-signin" action="Driverupdate.php" method="get">
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-sm-4">
                           <input type="text" class="form-control" 
                            id="name" name="name" value="<?php echo $row['name']; ?>" placeholder="Enter Driver name"/>
                          </div>
                       </div>
                       <br>
                    <div class="form-group">
                  ...
                  <div class="col-sm-4">
                        <input type="text" class="form-control"
                             id="bus" name="bus" value="<?php echo $row['assigned_bus']; ?>" placeholder="Enter Bus Number"/>
                </div>
                </div>
                <br>
                <div class="form-group">
            ...
            <div class="col-sm-4">
                        <input class="form-control" id="age" type="number" name="age" value="<?php echo $row['age']; ?>"
          ...
          <br>
                 <div class="form-group">
                  ...
                  <div class="col-sm-4">
                        <input type="number" class="form-control"
                            ...
                            value="<?php echo $row['phone']; ?>" placeholder="Enter phone number"/>
                </div>
                </div>
                <br>
                 <div class="form-group">
                  ...
                  <div class="col-sm-4">
                        <input type="text" id="uname" name="uname" class="form-control" value="<?php echo $row['username']; ?>" 
                ...
                <div class="column right" >
                  ...
                  <div class="col-sm-4">
                        <input type="text" id="name1" name="name1" class="form-control" value="<?php echo $row['assigned_area']; ?>"
                ...
                <!--<div class="col-sm-4">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-4">
                        <input type="text" class="form-control"
                            id="aname" name="aname" value="<?php echo $row['address']; ?>"  placeholder="Enter Address"/>
                </div>
                </div>
                <br>
                 <div class="form-group">
                  ...
                  <div class="col-sm-4">
                        <input type="time" class="form-control"
                            id="time1" name="time1" value="<?php echo $row['picking_time']; ?>"
                            placeholder="Enter Picking time"/>
                </div>
                </div>
                <br>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                        <input type="time" class="form-control"
                            id="time2" name="time2" value="<?php echo $row['dropping_time']; ?>" placeholder="Enter Dropping time"/>
                </div>
                </div>
                <br>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                        <input type="password" class="form-control"
                            id="pwd" name="pwd" value="<?php echo $row['password']; ?>" placeholder=" Retype-password"/>
                ...
                <br>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-1 col-sm-10">
                      <button type="submit" class="btn btn-default">Update Driver</button>
