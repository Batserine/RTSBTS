    ...
    <div class="modal-dialog">
      ...
      //  session_start();
       // $id = $_SESSION['bus_number'];
        ...
        $query = "SELECT * FROM bus_details WHERE bus_number  = '$id'";
        $response = @mysqli_query($db, $query);
        if ($response) {

            while ($row = mysqli_fetch_array($response)) {
?>
        <form class="form-signin" action="updatebus.php" method="get">
                     ...
                     <div class="form-group">
                          ...
                          <div class="col-sm-8">
                           <input type="text" class="form-control" 
                            id="namea" name="namea" value="<?php echo $row['bus_number']; ?>"  placeholder="Enter Bus Number"/>
                          </div>
                        </div>
                        <br>
                        <br>
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                           <input type="text" class="form-control" name="id"
                            id="schoolemployeeID" 
                            value="<?php echo $row['Engine_Number']; ?>" namplaceholder="Enter Engine Number"/>
                          </div>
                        </div>
                        <br>
                        <br>
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                           <input type="number" name="age"class="form-control" 
                            id="age" value= "<?php echo $row['Number_of_trips']; ?>"placeholder="BUS_ID"/>
                          </div>
                        </div>
                        <br>
                        <br>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                           <input type="number" class="form-control" 
                            id="age1" name ="age1" value="<?php echo $row['Manufacturing_year']; ?>"placeholder="Enter Number of trips"/>
                          </div>
                        </div>
                        <br>
                        <br>
                        <div class="form-group">
                          ...
                          <div class="col-sm-8">
                           <input type="text" class="form-control" name="name"  value="<?php echo $row['Area_of_assigning']; ?>"
                            id="name" placeholder="Enter Assigned Areas"/>
