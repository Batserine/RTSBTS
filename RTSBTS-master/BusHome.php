...
.modal-body .form-horizontal .col-sm-offset-2 {
 ...
 .modal-body .form-horizontal6  .col-sm-2,
.modal-body .form-horizontal6 .col-sm-10 {
    width: 100%
}
...
<div class="col-md-8">
<!-- Button trigger modal for remove bus -->
<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModalHorizontal2">
     Fuel Details
</button>
</div>
<div class="col-md-2">
<!-- Button trigger modal for remove bus -->
<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModalHorizontal3">
   Maintenance Details
</button>
</div>
<br>
...
<div class="col-md-8">
         ...
         <p>Select a Bus number to live track</p>
...
<div class="row">
  <div class="col-sm-8">
  <!-- Button trigger modal for adding bus -->
<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModalHorizontal6">
    Add Driver
</button>
</div>
...
<div class="col-md-2">
<!-- Button trigger modal for remove bus -->
<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModalHorizontal7">
...
<br>
 <div class="col-sm-8">
  <!-- Button trigger modal for adding bus -->
<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModalHorizontal8">
    Add Parent
</button>
</div>
<div class="col-md-2">
<!-- Button trigger modal for remove bus -->
<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModalHorizontal9">
