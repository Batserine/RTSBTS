     ...
     <?php
      ...
      //  session_start();
       // $id = $_SESSION['bus_number'];
        ...
        <form class="form-signin" action="adminparentupdate.php" method="get">
          <?php
        $query = "SELECT * FROM student WHERE parent_name  = '$id'";
             ...
             <div class="form-container">
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-sm-4">
                           <input type="text" class="form-control" 
                            id="name" name="name" value="<?php echo $row['parent_name']; ?>"  placeholder="Enter Parent name"/>
                          </div>
                       </div>
                       <br>
                    <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-4">
                        <input type="number" class="form-control"
                            id="phone_number" name="phone number" value="<?php echo $row['contact']; ?>" placeholder="Enter phone number"/>
                </div>
                </div>
                <br>
                 <div class="form-group">
                  ...
                  <div class="col-sm-4">
                        <input type="text" id="named" name="named" class="form-control" value="<?php echo $row['username']; ?>"
                ...
                <div class="column right" >
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-4">
                        <input type="text" class="form-control"
                            id="namec" name="namec"  value="<?php echo $row['address']; ?>"  placeholder="Enter Address"/>
                </div>
                </div>
                <br>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                        <input type="text" class="form-control"
                            id="nameb" name="nameb"  value="<?php echo $row['driver_id']; ?>" placeholder="Enter Address"/>
                </div>
                </div>
                <br>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                        <input type="password" class="form-control"
                            id="pwd" name="pwd" value="<?php echo $row['password']; ?>"  placeholder="password"/>
